...
function AboutPage() {
  return (
    <DocsLayout
      ...
      intro={
        <>
          GLIMPS is a small, zero-config formatter that sits between your shell and your
    ...
    >
      <section className="space-y-4">
        ...
        <P>
          GLIMPS is not a new terminal, not a shell, and not a shell hook. It re-execs your
        ...
        <P>
          ...
          legible, and never do anything else. GLIMPS is zero-config by default — an optional{" "}
      ...
      <section className="space-y-4">
        <H2 id="why">Why GLIMPS exists</H2>
        <P>
        ...
        <P>
          ...
          language-specific pretty-printers. GLIMPS takes the opposite bet — that a very
      ...
      <section className="space-y-4">
        ...
        <UL>
          ...
          <li>Not a general "pretty printer" — GLIMPS refuses to reformat anything it isn't confident about.</li>
        </UL>
        <Callout title="on trust">
          If GLIMPS ever misbehaves, turn it off. Because it wraps the whole shell, the
      ...
      <section className="space-y-4">
        ...
        <P>
          When in doubt, GLIMPS emits bytes exactly as it received them. Binary streams,
        ...
        <P>
          ...
          because GLIMPS did something — and you can see exactly where.
        </P>
        <H3 id="silent">Silent when idle</H3>
        <P>
          GLIMPS never prints its own diagnostics into your session. No banners, no
      ...
      <section className="space-y-4">
        ...
        <P>
          GLIMPS is built on the proven PTY-supervisor model — the same approach used by{" "}
          ...
          output. Only the process that owns the PTY can. GLIMPS owns it, and uses OSC-133
          shell-integration markers to find exactly where each command's output begins and
          ends.
        </P>
        <P>
          It ships as a single native Rust binary with no runtime dependencies. GLIMPS is
          currently in beta: macOS with zsh or bash today, with Linux as a supported build
          target, following a versioned roadmap from v0.1 toward v2.0.
        </P>
      </section>
      ...
      <section className="space-y-4">
        ...
        <P>
          GLIMPS is released under the MIT license. It draws on ideas and prior art from the
          ...
          <Code>delta</Code>, and to the PTY-supervisor lineage of ChromaTerm. GLIMPS does
